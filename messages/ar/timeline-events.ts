export const timelineEventsAr = {
  line: {
    ...
    patient_validation_skipped: {
      patient: {
        ...
        pharmacist_proposed_in_response: "لم تُختَر",
  ...
  lineBody: {
    ...
    validationSkippedProposedPatient: "هذا الاقتراح ليس جزءاً من اختيارك المؤكَّد.",
    ...
    withdrawAutoClosurePatient: "سُحب تلقائياً عند الإغلاق لعدم الاستلام عند الصندوق.",
    ...
    epilogueExpiredPatient: "انتهت صلاحية الطلب.",
    ...
    epilogueClosedPatient: "أُغلِق الطلب.",
    ...
    fulfillmentOrdered: "طُلِب من المورد",
    fulfillmentArrived: "وصل للصيدلية، جاهز للاستلام",
    fulfillmentPending: "قيد تحديد التوفر",
  },
};
