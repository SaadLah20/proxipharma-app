...
export const demandesFr = {
  ...
  responded: {
    ...
    altTab: "Alternative {n}",
    altTabShort: "Alt.{n}",
    browseHint: "Consultez les options puis cochez celle à retenir",
    optionViewing: "Option consultée",
    optionRetained: "Option retenue",
    retainTabAria: "Retenir {label}",
    retainTabAriaOff: "Ne plus retenir {label}",
    retainShortPrincipal: "Demande initiale",
    retainShortAlt: "Alternative {n}",
  ...
  respondedBuckets: {
    ...
    indispo_with_alts: {
      ...
      hint: "Consultez les options puis cochez celle à retenir",
...
export const accountFr = {
  ...
  settingsSubtitle: "Gérez votre compte. Vos dossiers restent dans le menu principal.",
  quickAccessTitle: "Accès rapide",
  language: "Langue",
  languageHint: "Interface en français ou en arabe.",
  loginSecurityAdvancedSubtitle: "E-mail de récupération et liaison téléphone",
  phoneLinkSuccess: "Connexion par téléphone activée ({phone}). Vous pouvez vous connecter avec ce numéro ou votre e-mail.",
  phoneLinkFailed: "Échec de l’activation.",
  phoneLinkAlreadyActive: "Connexion par téléphone déjà active.",
