...
- **Notifs hors-app** : SMS métier off (**`20260811_001`**) ; WhatsApp patient P0 livré — doc **`RUNBOOK.md`** §9–§10, **`AGENTS.md`**. Phrase reprise **§13.60**.
...
- **Notifs hors-app (juin 2026)** : **WhatsApp** patient P0 **`responded` / `treated`** (worker + modèles Meta) ; **SMS métier off** (**`20260811_001`**) ; e-mail inchangé. OTP Auth = Twilio Verify (inchangé). Historique SMS : **`20260522_001`**–**`002`**, garde inscription **`20260522_003`**.
