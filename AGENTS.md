...
| Reprise courte (infra à jour) | §13.71 (menu profil pharmacien), §13.70 (titres dossier patient + pharmacien), §13.69 (TDB pharmacien), §13.67 (hubs + footers), §13.66 (WhatsApp lot 3), §13.65 (inbox), §13.64 (expiration passage), §13.63 (photos catalogue), §13.62 (général), §13.61 (catalogue) |
