-- WhatsApp M2 lot 2 partiel : enqueue pharmacien pour dossier validé (confirmed).
-- Patient produit reçu / rupture : enqueue déjà OK depuis 20260823_001.
...
comment on function public._enqueue_external_notifications_from_app_row() is
  'File externe : e-mail + WhatsApp. M2 partiel : confirmed pharma + produit reçu / rupture patient.';
