-- Patient modifie une demande déjà envoyée (submitted / in_review) :
-- conserver submitted_at initial dans le bandeau ; la modification reste tracée dans l'historique.
...
'Remplace lignes (qté 1–10, sans doublon) ; depuis submitted/in_review conserve submitted_at ; historique trace la modification.';
