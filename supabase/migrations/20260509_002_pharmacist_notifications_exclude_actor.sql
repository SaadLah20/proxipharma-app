-- Notifications in-app pharmacien : ne pas notifier l'auteur de la transition
-- (ex. passage processing / treated / annulation par le même pharmacien).
-- Les autres pharmaciens de l'officine restent notifiés. Si changed_by est NULL
-- (job / RPC service), tous les pharmaciens concernés reçoivent la notif.
