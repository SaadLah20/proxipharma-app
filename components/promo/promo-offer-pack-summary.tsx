        ...
        <div>
          ...
          <ul className={clsx("mt-2", isDetail ? "grid gap-2 sm:grid-cols-2" : "space-y-1.5")}>
            {products.map((l, i) => (
              ...
              >
                <ProductThumb photoUrl={l.photo_url} variant={resolvedVariant} />
        ...
        >
          ...
          <ul className={clsx("mt-2.5", isDetail ? "space-y-2" : "mt-1 space-y-1")}>
            {gifts.map((l, i) => (
              ...
              >
                {isDetail ? (
                  <ProductThumb photoUrl={l.photo_url} variant="detail" gift />
                ) : (
  ...
  return (
    <Image
      ...
      className={clsx(
        ...
        variant === "detail" ? "size-[3.25rem] border-amber-200/60" : "size-8 sm:size-10"
      )}
      unoptimized
    />
  );
