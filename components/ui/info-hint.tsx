    ...
    <span className={clsx("relative inline-flex align-middle", className)}>
      ...
      {open ? (
        <span
          ...
          role="tooltip"
          className={clsx(
            "absolute left-1/2 z-50 w-[min(calc(100vw-2.5rem),18rem)] -translate-x-1/2 rounded-xl border border-border bg-card px-3 py-2 text-[11px] leading-relaxed text-card-foreground shadow-lg ring-1 ring-black/5 sm:left-auto sm:right-0 sm:translate-x-0",
